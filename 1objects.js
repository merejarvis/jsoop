...
// To define a getter/setter, use Object.defineProperty(): this allows user to access private values
Object.defineProperty(this, 'defaultLocation', {
    get: function() { return defaultLocation; },
    set: function(value) {
        if(!value.x) {
            throw new Error ('must have x value!')
        }
...
let blah = new Circlo(2)


// circle1.defaultLocation = 3